...
class SOTInterface:
    ...
    def defineCollisionAvoidance(self):
        ...
        '''
        self.collisionAvoidance.createcollisionlink("skin_0","box","internal",(0.25,0.09,0.09,0,0,0,0.653, 0.590, 2.678))
        self.collisionAvoidance.createcollisionlink("skin_1","box","internal",(0.25,0.09,0.09,0,0,0,1.213, 0.590, 2.678))
        self.collisionAvoidance.createcollisionlink("skin_2","box","internal",(0.25,0.09,0.09,0,0,0,2.385, 0.600, 2.658))
        self.collisionAvoidance.createcollisionlink("skin_3","box","internal",(0.25,0.09,0.09,0,0,0,2.435, 0.600, 2.658))
        self.collisionAvoidance.createcollisionlink("skin_4","box","internal",(0.25,0.09,0.09,0,0,0,2.910, 0.646, 2.562))
        self.collisionAvoidance.createcollisionlink("skin_5","box","internal",(0.25,0.09,0.09,0,0,0,-2.658, 0.626, 2.606))
        self.collisionAvoidance.createcollisionlink("skin_6","box","internal",(0.25,0.09,0.09,0,0,0,-2.158, 0.626, 2.606))
        self.collisionAvoidance.createcollisionlink("skin_7","box","internal",(0.25,0.09,0.09,0,0,0,-1.641, 0.636, 2.584))
        self.collisionAvoidance.createcollisionlink("skin_8","box","internal",(0.25,0.09,0.09,0,0,0,-1.027, 0.590, 2.678))       
        ...
        self.task_skinsensor.referenceInf.value = (0.04,)*11
        self.task_skinsensor.referenceSup.value = (1.0,)*11
        self.task_skinsensor.dt.value=0.5
        #self.task_skinsensor.controlSelec.value = '111111'
        '''
        gainPosition = GainAdaptive('gainPosition')
        gainPosition.set(0.1,0.1,125e3)
