...
def convert(point):
    point_modified = [0,]*6+point[0:6]+[0,]*8
...
def yaml_file_path(file_name):
    return rospack.get_path('giftbot_data')+'/trajectories/'+file_name+'.yaml'
...
if __name__=='__main__':
    ...
    print 'Planning'
    yaml_file = yaml_file_path('home_to_pick1')
    #send_waypoints(client,yaml_file)
