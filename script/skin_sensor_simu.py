...
class proximity_range_bridge:
    ...
    def defineProximityData(self):
        ...
        self.proximity_vector.data = [0.6,] *self.length 
        self.proximity_pose = Matrix()
        self.proximity_pose.width = 7
        pose_length = self.proximity_pose.width* self.length
        self.proximity_pose.data = [0,]*pose_length
    ...
    def run(self):
        ...
        try:
            ...
            #self.proximity_pose.data = list(self.l0)                 
...
def slowupanddown():
    for j in range(10): 
        prb.proximity_vector.data[3] -=  0.001
        time.sleep(0.3)
    time.sleep(4)    
    for i in range(15): 
    	prb.proximity_vector.data[3] += 0.001
